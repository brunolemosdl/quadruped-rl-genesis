...
[Benchmark Diagram](#benchmark-diagram) • [Overview](#experiment-overview) • [Visualization Mode Walkthrough](#visualization-mode-walkthrough) • [Success rollouts](#success-rollouts) • [Failure Examples](#failure-examples) • [Algorithms](#algorithm-matrix) • [Quick Start](#quick-start) • [Training](#training-workflows) • [Benchmark](#benchmark-and-extensions) • [Artifacts](#artifact-layout) • [Setup](#setup) • [Citation](#how-to-cite)
...
All **goal-reaching clips in this section are PPO** (best checkpoint(s) from the paper-aligned **`flat`** / **`irregular`** experiments). They show headless benchmark rollouts under the permissive termination success used in training and evaluation; SAC and TD3 are not shown here because they did not reach comparable success in the published comparison.

### Flat terrain

On the planar baseline, the rollouts below are acceptable for completing the navigation objective: they reach the goal reliably enough for demonstration, while still leaving room for better stopping precision and robustness under the stricter acceptance gates.

<table align="center">
  <tr>
    <td width="50%">
      <img src="media/gifs/success_flat_1.gif" alt="PPO quadruped rollout in Genesis on flat terrain — example 1" width="100%" />
    </td>
    <td width="50%">
      <img src="media/gifs/success_flat_2.gif" alt="PPO quadruped rollout in Genesis on flat terrain — example 2" width="100%" />
    </td>
  </tr>
</table>
...
On the procedural irregular heightmap, the rollouts below are acceptable for completing the navigation objective: they reach the goal reliably enough for demonstration, while still leaving room for better stopping precision and robustness under the stricter acceptance gates.

<table align="center">
  <tr>
    <td width="50%">
      <img src="media/gifs/success_irregular_1.gif" alt="PPO quadruped rollout in Genesis on procedural irregular terrain — example 1" width="100%" />
    </td>
    <td width="50%">
      <img src="media/gifs/success_irregular_2.gif" alt="PPO quadruped rollout in Genesis on procedural irregular terrain — example 2" width="100%" />
    </td>
  </tr>
</table>
...
Illustrative **failure modes** from earlier settings with weaker reward shaping or looser success metrics — not the final paper configuration; qualitative counterexamples only.

<table align="center">
  <tr>
    <td width="50%">
      <img src="media/gifs/backwards.gif" alt="Failure mode: robot navigating backwards due to weak reward shaping" width="100%" />
    </td>
    <td width="50%">
      <img src="media/gifs/jumping.gif" alt="Failure mode: robot jumping due to weak success-metric specification" width="100%" />
    </td>
  </tr>
</table>
